	...
	<div class="container-fluid">
		...
		<div class="nav navbar">
			<%-- <img class="navbar-brand"
				src="<c:url value="/resource/images/sportyshoes-logo.png"/>"
				href="<c:url value="/index"/>" width="300px" height="300px"
				alt="logo-image"></img> --%>
		</div>
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="<c:url value="/index1" />">Sporty Shoes</a>
		</div>
		<div class="collapse navbar-collapse" id="myNavbar">
			...
			<%-- 	<li><a href=" <c:url value="/saveOrderReceipt" />">Placed Orders</a></li> --%>
			<%-- <li><a href=" <c:url value="/userList" />">Users List</a></li> --%>
				...
				<security:authorize access="hasRole('ROLE_ADMIN')">
					<li><a href=" <c:url value="/admin/product/addProduct" />">Add
							Product</a></li>
							<li> <a href="<c:url value="/admin/customerManagement"/>">Customer Management</a></li>
							<li> <a href="<c:url value="/admin/customerOrder"/>">Customer Order</a> </li>
					<%-- <li><a href=" <c:url value="/userList" />">Users List</a></li> --%>
				</security:authorize>
			</ul>
