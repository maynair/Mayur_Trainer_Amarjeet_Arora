    ...
    <div class="container">
	   ...
	   <div class="page-header title">
		...
		<div class="form-layout" >
	       ...
	       <form:form   action="${pageContext.request.contextPath}/register"   method="post" commandName="customer"     class="form-horizontal"  >
				...
				<div class="form-group has-success">
					...
					<div class="col-xs-9">
					   ...
					   <form:input path="billingAddress.strretName"   class="form-control" placeholder="Enter Street Name" id="billingAddress.strretName" />
					</div>
				</div>
				...
				<div class="form-group has-success">
					...
					<div class="col-xs-9">
					   ...
					   <form:input path="shippingAddress.strretName"    class="form-control" placeholder="Enter Street Name" id="shippingAddress.strretName" />
					</div>
				</div>
