				...
				<form:form method="post" action="${url}" commandName="productFormObj" enctype="multipart/form-data">
					<div class="col-sm-12">
						...
						<form:label path="productCategory">Product Category</form:label>
								 <form:radiobutton path="productCategory" value="Running"/>Running
								 <form:radiobutton path="productCategory" value="Climbing"/>Climbing
								 <form:radiobutton path="productCategory" value="Soccer"/>Soccer
								 <form:radiobutton path="productCategory" value="Cricket"/>Cricket
						</div>
						<div class="row">
