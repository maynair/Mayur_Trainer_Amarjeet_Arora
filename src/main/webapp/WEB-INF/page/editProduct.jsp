				...
				<form:form method="post" action="${url}"
					...
					<div class="col-sm-12">
						<div class="row">
							<div class="col-sm-6 form-group">
								...
								<form:input type="text" placeholder="Enter ProductId.."
									class="form-control" path="productId"></form:input>
							</div>
							<div class="col-sm-6 form-group">
						...
						<div class="form-group">
							...
							<form:radiobutton path="productCategory" value="Running" />   <!--value="Android"  -->
							Running
							<form:radiobutton path="productCategory" value="Climbing" />   <!--value="Windows"  -->
							Climbing 
							<form:radiobutton path="productCategory" value="Soccer" />    <!-- value="Linux" -->
							Soccer
							<form:radiobutton path="productCategory" value="Cricket" />     <!-- value="Mac"  -->
							Cricket
						</div>
						<div class="row">
