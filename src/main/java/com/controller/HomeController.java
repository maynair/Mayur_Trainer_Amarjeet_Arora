...
public class HomeController {
	...
	public ModelAndView sayHello() {
		return new ModelAndView("hello", "hello", "Hello Mr.Mayur Nair");
	}
	...
	public String sayUserList() {
		return "userList";
	}
	
	@RequestMapping("/saveOrderReceipt")
	public String saySaveOrderReceipt() {
		return "saveOrderReceipt";
	}
